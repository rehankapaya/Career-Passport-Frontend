        ...
        viewMode === 'grid' ? (
          <div style={styles.gridContainer}>
            {pendingStories.map(story => (
              <div key={story.story_id} style={styles.gridCard}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '12px' }}>
                  ...
                  <div>
                    ...
                    {story.domain && (
                      <span style={styles.categoryBadge}>{story.domain}</span>
                    )}
                  </div>
                </div>

                {story.story_text && (
                  <p style={styles.cardDescription}>{story.story_text}</p>
                )}
          ...
          <div style={styles.listContainer}>
            ...
            {pendingStories.map(story => (
              <div key={story.story_id} style={styles.tableRow}>
            ...
            <div style={styles.modalBody}>
              {selectedStory.image_url && (
                <div style={styles.modalImageContainer}>
                  <img
                    src={`${apiurl}/${selectedStory.image_url.replace(/\\/g, "/")}`}
                    alt="Story"
              ...
              <div style={styles.modalInfo}>
                ...
                {selectedStory.domain && (
                  <span style={styles.categoryBadge}>{selectedStory.domain}</span>
                )}
...
const styles = {
  ...
  tableHeader: {
    display: 'grid',
    gridTemplateColumns: '80px 1fr 1fr 2fr 1fr',
    padding: '15px 20px',
    backgroundColor: '#f8f9fa',
    fontWeight: '600',
    color: '#495057',
